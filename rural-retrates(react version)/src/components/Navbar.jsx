  ...
  return (
    <header
      className={`fixed w-full z-50 transition-all duration-300 ${
        scrolled ? "bg-white shadow-md py-2" : "bg-gradient-to-r from-blue-200 to-blue-400 py-4"
      }`}
    >
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center">
        ...
        {/* Desktop Menu */}
        <ul className="hidden md:flex space-x-8 items-center font-medium text-blue-900">
          <li>
          ...
          <li className="relative group">
            ...
            <ul className="absolute hidden group-hover:block bg-white shadow-md mt-2 p-2 rounded">
              <li><a href="/services#tours" className="block px-4 py-2 hover:bg-blue-50">Holiday Packages</a></li>
              <li><a href="/services#bus" className="block px-4 py-2 hover:bg-blue-50">Bus Booking</a></li>
              <li><a href="/services#homestays" className="block px-4 py-2 hover:bg-blue-50">Homestays Booking</a></li>
            </ul>
          </li>
          <li>
        ...
        <div className="hidden md:flex items-center space-x-4">
          <div className="flex border rounded overflow-hidden">
            ...
            <button className="bg-blue-700 text-white px-3 hover:bg-blue-800 transition"><FaSearch /></button>
          </div>
          <button 
      ...
      {mobileMenuOpen && (
        <div className="md:hidden fixed inset-0 bg-black bg-opacity-50 z-50 flex">
          <div className="bg-white w-64 h-full p-6 transform transition-transform duration-300 translate-x-0">
            ...
            <ul className="space-y-6 font-medium text-blue-900">
