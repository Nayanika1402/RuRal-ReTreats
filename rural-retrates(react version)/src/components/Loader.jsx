...
const Loader = () => {
  return (
    <div className="fixed inset-0 bg-blue-300 flex flex-col justify-center items-center z-50">
      {/* Logo */}
      <img 
      ...
      {/* Loader Text */}
      <p className="mt-6 text-xl font-semibold text-blue-700 animate-pulse text-center max-w-md">
        Discovering hidden gems &amp; cozy homestays in the heart of nature... 🌿🌄
      </p>
      
      {/* Animated Loading Dots */}
      <div className="mt-4 flex space-x-2">
        <span className="w-3 h-3 bg-blue-700 rounded-full animate-bounce delay-75"></span>
